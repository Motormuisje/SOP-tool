...
| H8 | `ui/routes/config.py:109` | Master-file upload writes `upload_dir / file.filename` unsanitized — same path-traversal class fixed in workflow.py, missed in this route. | fixed (`secure_filename` in `ui/routes/config.py:148-150`) |
