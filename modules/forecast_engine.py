...
class ForecastEngine:
    ...
    def _calculate_aux_columns(self, mat_num: str, forecast_data: Dict[str, float]) -> tuple:
        ...
        #
        # With forecast_align_to_month each period is its own key, so a planning
        # month carries the forecast of that same calendar month. This departs
        # from the VBA's positional block copy on purpose — see
